...
It records API calls, management events, and data events made on your account and delivers log files to an S3 bucket. It provides a complete history of AWS account activity.
--------------------------------------------------------------------------------------------------------------------------------------------------
