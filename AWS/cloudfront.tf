...
Amazon CloudFront is a highly secure, global Content Delivery Network (CDN) service that securely delivers static, dynamic, streaming, 
and interactive content using edge locations distributed around the world. It caches content at edge locations to reduce latency and improve performance.
