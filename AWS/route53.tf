...
TTL is a setting in DNS records that tells resolvers how long to cache the response. A lower TTL leads to quicker propagation of DNS changes but 
increases DNS query traffic. Higher TTL improves performance and reduces DNS cost.
--------------------------------------------------------------------------------------------------------------------------------------------------
