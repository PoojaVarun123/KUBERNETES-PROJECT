1. What is Amazon Route 53?
    Amazon Route 53 is a highly available and scalable cloud Domain Name System (DNS) web service designed to give developers and
    businesses an extremely reliable and cost-effective way to route end users to Internet applications. The “53” refers to the DNS port number.
...
4. What is the TTL (Time to Live) in DNS records?
      TTL is a setting in DNS records that tells resolvers how long to cache the response. A lower TTL leads to quicker propagation of DNS 
      changes but increases DNS query traffic. Higher TTL improves performance and reduces DNS cost.
--------------------------------------------------------------------------------------------------------------------------------------------------
...
7. Can Route 53 be used for private DNS resolution?
    Yes, by creating Private Hosted Zones, Route 53 can resolve domain names within a VPC, useful for internal services like microservices or 
    databases not exposed to the internet.
--------------------------------------------------------------------------------------------------------------------------------------------------
8. What is DNS failover in Route 53?
    It refers to Route 53’s ability to automatically switch DNS resolution to a healthy resource if a health check fails for the primary endpoint. 
